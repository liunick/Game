...
public class EntityRenderer {
	...
	public EntityRenderer(StaticShader shader, Matrix4f projectionMatrix) {
		this.shader = shader;
		shader.start();
		shader.loadProjectionMatrix(projectionMatrix);		//Load projectmatrix up  to shader ONCE as in constructor and then we 
	...
	private void unbindTexturedModel() {
		MasterRenderer.enableCulling();			//Ensure that the next model has transparency
